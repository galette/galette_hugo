...
See [Galette 1.0.0 changelog](https://doc.galette.eu/en/develop/changelog.html#v1000) for all details.

All plugins needs to be updated as well, use the nightly archive available for each one, see [plugins documentation](https://doc.galette.eu/en/develop/plugins/) ;-)

...
{{< img_link path="/site/assets/images/screenshots/prefs_security.png" alt="Security preferences screenshot" >}}

* Choose and order visible fields on members list

{{< img_link path="/site/assets/images/screenshots/default_memberslist.png" alt="Default members list screenshot" >}}

{{< img_link path="/site/assets/images/screenshots/custom_memberslist.png" alt="Custom members list screenshot" >}}

* Support of RTL languages in PDF

{{< img_link path="/site/assets/images/screenshots/rtl_pdf.png" alt="LTR/RTL in PDF files screenshot" >}}

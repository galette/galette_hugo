...
<p>Some bugs were fixed too ({{< doclink path="changelog.html#v077" >}}check the changelog for more details{{< /doclink >}}), and then here is Galette 0.7.7 as well as plugin Auto 1.0.0 :)</p>

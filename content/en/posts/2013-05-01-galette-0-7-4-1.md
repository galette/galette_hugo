...
<p>Many issues have been fixed, see <a href="{{ site.galette.doc_url }}/{{ site.lang }}/master/changelog.html#v0741" hreflang="fr">modifications list</a> for the full list.</p>
...
A check is now performed at install time to detect failing cases, and a <a href="{{ site.galette.doc_url }}/{{ site.lang }}/master/development/codage.html?highlight=GALETTE_UNSECURE_PASSWORDS#configuration-du-comportement" hreflang="fr">workaround</a> was provided.</p>

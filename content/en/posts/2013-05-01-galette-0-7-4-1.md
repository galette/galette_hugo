...
<p>Many issues have been fixed, see {{< doclink path="changelog.html#v0741" >}}modifications list{{< /doclink >}} for the full list.</p>
...
A check is now performed at install time to detect failing cases, and a {{< doclink path="development/codage.html?highlight=GALETTE_UNSECURE_PASSWORDS#configuration-du-comportement" >}}workaround{{< /doclink >}} was provided.</p>

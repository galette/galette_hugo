...
<ul>
    <li>{{< doclink path="faq/" >}}Frequently Asked Questions{{< /doclink >}}</li>
    <li>{{< doclink path="installation" >}}Galette&#039;s install howto{{< /doclink >}}</li>
    <li>{{< doclink path="installation/update.html" >}}https://doc.galette.eu/en/master/installation/update.html{{< /doclink >}}</li>
</ul>

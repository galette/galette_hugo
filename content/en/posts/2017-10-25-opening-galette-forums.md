...
<p>I hope that seems worthwhile; this has been a while this is planned ;-)</p>


<p>A very big thanks to Roland, who talked about that again, and has sponsorized theme creation and forums setup with a generous donation :)</p>


<p>Those forums are openend as an experiment for now. If they were spammed, attacked (hey Galette's demo...); or even if users would not respect rules (speak correctly, no insults, ...); they would be quickly closed.</p>

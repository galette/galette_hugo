...
Plusieurs anomalies ont également été corrigées ; y-compris des problèmes avec PHP 8.0 entre autres. Consultez le [journal des changements de Galette 0.9.5](https://doc.galette.eu/fr/master/changelog.html#v095) pour tous les détails.

Malheureusement, certaines modifications requises dans les coulisses (sur la bibliothèque qui gère l'injection de dépendances) rend tous les plugins incompatibles, il est nécessaire de les mettre à jour, reportez-vous à [la documentation des plugins](https://doc.galette.eu/fr/master/plugins/) ;-)

{{< download version="0.9.5" archive="true" >}}

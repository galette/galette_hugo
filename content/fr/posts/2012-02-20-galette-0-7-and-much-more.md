...
<p>C'est ainsi avec un plaisir non dissimulé que je vous informe de la sortie de Galette en version 0.7 :-) Le projet en profite pour faire peau neuve (nouveau site, nouvelle documentation, nouveau gestionnaire de bogues, migration de Subversion vers Git).</p>


<p>Vous pouvez récupérer cette version à l'adresse :<br />
<a href="https://galette.eu/download/archives/galette-0.7.0.tar.bz2">https://galette.eu/download/archives/galette-0.7.0.tar.bz2</a></p>
...
<p>Un grand merci à tous ceux qui ont participé à cette version&nbsp;! :-)</p>

...
Consultez le [journal des changements de Galette 0.9.6](https://doc.galette.eu/fr/master/changelog.html#v0960) pour tous les détails.

Malheureusement, certaines modifications requises dans les coulisses (vérifications CSRF) rend presque tous les plugins incompatibles, il est nécessaire de les mettre à jour, reportez-vous à [la documentation des plugins](https://doc.galette.eu/fr/master/plugins/) ;-)

{{< download version="0.9.6" archive="true" >}}
